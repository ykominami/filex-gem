...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Load a text file, yaml fortmat file and eruby format file and expand it.}
  spec.description   = %q{Load a text file, yaml fortmat file and eruby format file and expand it.}
  spec.homepage      = ""
  spec.license       = "MIT"
